class Pelota {
    ...
    // Método para cambiar el color de la pelota
    setColor(color) {
      // TODO. Asignar el nuevo color a la propiedad color
      this.#color = color;
      // TODO. Invocar al método dibujar para actualizar el color de la pelota
      this.dibujar();
    }
  }
